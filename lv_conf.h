...
#if LV_TICK_CUSTOM == 1
#define LV_TICK_CUSTOM_INCLUDE  "3ds.h"       /*Header for the sys time function*/
#define LV_TICK_CUSTOM_SYS_TIME_EXPR (osGetTime())     /*Expression evaluating to current systime in ms*/
